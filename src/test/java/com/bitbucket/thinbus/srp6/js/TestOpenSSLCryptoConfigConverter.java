...
public class TestOpenSSLCryptoConfigConverter {
	...
	public void testVector1() throws Exception {
		...
		Assert.assertTrue(result.contains("g base10: 2|"));
		Assert.assertTrue(result.contains("N base10: "+(new BigInteger("00a0f8c5414f344b39d6f54fc9a18731ec96f6724605c3a2db8c3e9504528eec63", 16).toString(10))));
	}
	...
	public void testVector2() throws Exception {
		...
		String result = asString(converter.run("SHA-256", config), "|");
		Assert.assertTrue(result.contains("g base10: 2|"));
		Assert.assertTrue(result.contains("N base10: "+(new BigInteger("", 16).toString(10))));
	}
}
